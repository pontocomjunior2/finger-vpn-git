    ...
    try:
        ...
        if temporal_dist:
            ...
            for dist in temporal_dist:
                print(
                    f"  {dist[0].strftime('%Y-%m')}: {dist[1]} dias com duplicatas, {dist[2]} duplicatas totais"
                )
        ...
        if field_analysis:
            ...
            for analysis in field_analysis:
                ...
                print(
                    f"    Ocorrências: {analysis[5]} | ISRCs distintos: {analysis[6]} | Identified_by distintos: {analysis[7]} | Cidades distintas: {analysis[8]}"
                )
        else:
        ...
        if null_analysis:
            ...
            for analysis in null_analysis:
                print(f"  {analysis[1]} - {analysis[2]} ({analysis[3]} {analysis[4]})")
                print(
                    f"    Total: {analysis[5]} | NULL: {analysis[6]} | Não-NULL: {analysis[7]}"
                )
        else:
        ...
        if isrc_patterns:
            ...
            for pattern in isrc_patterns:
                print(
                    f"  {pattern[0]}: {pattern[1]} ocorrências em {pattern[2]} rádios"
                )
        ...
        if encoding_issues:
            ...
            for issue in encoding_issues:
                ...
                print(
                    f"    Tamanhos: {issue[3]}, {issue[4]}, {issue[5]} | Ocorrências: {issue[6]}"
                )
        else:
