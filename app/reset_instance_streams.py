...
def reset_instance_streams():
    ...
    print(
        f"[{datetime.now()}] Resetando contador de streams da instância {SERVER_ID}..."
    )
        ...
        if response.status_code == 200:
            ...
            if instance_streams:
                ...
                release_response = requests.post(
                    ...
                    json={"server_id": SERVER_ID, "stream_ids": instance_streams},
                    timeout=10,
                )
    ...
    try:
        ...
        heartbeat_response = requests.post(
            ...
            json={"server_id": SERVER_ID, "current_streams": 0, "status": "active"},
            timeout=10,
        )
