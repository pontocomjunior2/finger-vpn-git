            ...
            self.validation_results.append(
                ValidationResult(
                    ...
                    message=(
                        ...
                        if db_valid
                        else "Database configuration incomplete"
                    ),
                    details={
            ...
            self.validation_results.append(
                ValidationResult(
                    ...
                    message=(
                        ...
                        if orch_valid
                        else "Orchestrator configuration incomplete"
                    ),
                )
            )
...
def main():
    ...
    parser.add_argument(
        "--environment", "-e", default="production", help="Environment to validate"
    )
