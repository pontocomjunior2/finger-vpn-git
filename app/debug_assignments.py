    ...
    try:
        ...
        if assignments:
            ...
            for assignment in assignments:
                print(f"  ID: {assignment['id']}, Stream: {assignment['stream_id']}, "
        ...
        for instance in instances:
            print(f"  Server: {instance['server_id']}, Streams: {instance['current_streams']}/{instance['max_streams']}, "
        ...
        if join_results:
            for result in join_results:
                print(f"  Stream: {result['stream_id']}, Server: {result['server_id']}, "
